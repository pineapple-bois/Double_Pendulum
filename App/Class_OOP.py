...
class DoublePendulum:
    ...
    def time_graph(self):
        ...
        ax.plot(self.time, theta1_deg, 'b', label=r'$\theta_1$', linewidth=2)
        ax.plot(self.time, theta2_deg, 'g', label=r'$\theta_2$', linewidth=2)
        ax.set_xlabel('Time / seconds')
        ax.set_ylabel('Angular displacement / degrees')
        ax.set_title('Double Pendulum Time Graph')
        ax.legend(loc='best')
        ax.grid(True)
        return fig
    ...
    def phase_path(self):
        ...
        ax.set_title('Double Pendulum Phase Path')
        ax.legend(loc='best')
        ax.grid(True)
        return fig
